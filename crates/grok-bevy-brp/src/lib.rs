...
pub use eyesight::{
    ...
    montage_horizontal, packet_to_mcp_content, path_nonblack_fraction,
    path_true_magenta_pixel_count, png_nonblack_fraction, png_true_magenta_pixel_count,
    query_all_subjects, rank_primary_subject, region_preset_rect, see_diff, see_entity, see_motion,
    see_pack, see_region, see_scene, see_verify, side_orbit_camera_translation,
    subjects_from_query, translation_value_for_brp,

...
pub use eyesight::{
    ...
    gameplay_subject_score, height_band_subjects, height_readability_note,
    infer_app_state_from_subjects, is_child_mesh_part, is_known_pack, is_mostly_black_png,
    is_noise_subject, is_protected_top_level_name, is_structural_child_of_named_root,
    match_subjects_for_entity, mean_abs_diff, montage_horizontal, packet_to_mcp_content,
    pack_camera_restore_value, path_nonblack_fraction, path_true_magenta_pixel_count,
    ...
    EYESIGHT_SCHEMA, FULL_FRAME_NONBLACK_MIN, GAMEPLAY_NAME_HINTS, HEIGHT_BAND_NAME_HINTS,
    KNOWN_PACKS, TALL_ENTITY_PREFIXES, TRUE_MAGENTA_MAX_ON_SPRITE, VIEWS_SIMILAR_MEAN_ABS_MAX,
};

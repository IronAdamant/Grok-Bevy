//! Game root plugin for the 2D short-demo template (GAME_DOD).
...
use systems::{
    ...
    game_over_setup, gameplay_setup, hazard_collision, hazard_patrol_sine, loading_progress,
    loading_setup, menu_input, menu_setup, pause_input, pause_overlay_setup, player_movement,
    unpause_input, update_hud, victory_setup,
};
...
impl Plugin for GamePlugin {
    fn build(&self, app: &mut App) {
        ...
        // Opt-in Avian 2D (feature `physics`). Default gameplay stays transform-based.
        #[cfg(feature = "physics")]
        {
        ...
        app.init_state::<AppState>()
            ...
            // Do not OnExit(Playing) despawn — pause must keep the world.
            .add_systems(
                Update,
                (
                    player_movement,

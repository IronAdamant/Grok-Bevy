...
- Agent sight **hardening** (`/goal`): [docs/AGENT_SIGHT_HARDENING_PLAN.md](docs/AGENT_SIGHT_HARDENING_PLAN.md) — Tier 1–3; CD/IF craft dogfood (transparent sprites; complex non-block meshes; random height)  
